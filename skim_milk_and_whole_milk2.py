# -*- coding: utf-8 -*-
"""skim milk and whole milk2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12aOxtO2TkFvZiLBoUIMVmQZfTrklfauc
"""
...
model.add(LSTM(units=21, return_sequences=True, \
...
# fro whole milk
df = pd.read_excel('Wholemilktemp.xls')

Xwhole = df
ywhole = df.loc[:,['Tempertaure ']]

Xts = s1.transform(Xwhole)
Yts = s2.transform(ywhole)
...
# fro skim milk milk
df = pd.read_excel('skimmilktemp.xls')

#Xwhole = df.drop(['Tempertaure '],1)
Xskim = df
yskim = df.loc[:,['Tempertaure ']]
